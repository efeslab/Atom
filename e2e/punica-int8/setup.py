...
ext_modules.append(
    torch_cpp_ext.CUDAExtension(
        ...
        sources=["punica/ops/csrc/punica_ops.cc"] + glob("punica/ops/csrc/gen/*.cu") +
        glob("punica/ops/csrc/bgmv/*.cu") +
        glob("punica/ops/csrc/flashinfer_adapter/*.cu") +
        glob("punica/ops/csrc/rms_norm/*.cu") +
        glob("punica/ops/csrc/gemm/*.cu"),
        extra_compile_args=["-DFLASHINFER_ENABLE_FP8", "-DFLASHINFER_DECODE"]
    ))
