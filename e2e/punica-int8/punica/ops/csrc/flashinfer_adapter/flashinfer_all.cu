...
FOR_FlashInferBatchDecode_D(INST_FlashInferBatchDecodeKernel, __nv_fp8_e4m3);
...
FOR_FlashInferBatchDecode_D(INST_FlashInferInitKvKernel, __nv_fp8_e4m3);
...
FOR_FlashInferBatchDecode_D(INST_FlashInferAppendKvKernel, __nv_fp8_e4m3);
